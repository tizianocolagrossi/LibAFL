...
/// The standard corpus weight, same as aflpp, bu with bouns
pub type StdWeightedSchedulerWBonusOnTrackedInterestingMaps<O, S> = WeightedScheduler<CorpusWeightWBonusOnInterestingTrackedTestcaseScore<S>, O, S>;
